          ...
          <div className="col-sm-12 col-md-12 col-lg-4 pr-0">
            <div className={`${styles.leftContent}`}>
              ...
              <div className={`${styles.text}`}>
                ...
                <p>
                  Optimize processes, reduce costs and improve efficiency with
              ...
              <div className={`${styles.text}`}>
                ...
                <p>
                  Gain insights into the underlying causes of events to make
              ...
              <div className={`${styles.text}`}>
                ...
                <p>
                  Stay ahead of the competition by leveraging the latest
            ...
            <div className={`${styles.rightContent}`}>
              ...
              <div className={`${styles.bottomSection}`}>
                <div className={`${styles.colorBox} ${styles.colorPurple}`}>
                  ...
                  <div className={`${styles.textWrap}`}>
                    <p>
                      Reduce time for auditing <br />& compliance{" "}
                    </p>
