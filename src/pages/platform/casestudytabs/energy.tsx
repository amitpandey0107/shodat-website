        ...
        <div className={`${styles.mainContent} ${props.customClassName}`}>
            ...
            <div className={`${styles.infoContent}`}>
                ...
                <div className={`${styles.resultBox}`}>
                    <h3>Results</h3>
                    <div className={`${styles.resultText}`}>The implementation of Shodat eOps™ is leading to a significant improvement in the accuracy of battery life predictions, with accuracy rates close to 93%.
                    </div>
                    <div className={`${styles.resultText}`}>Proactive alerting and predictive maintenance strategies are resulting in a 25% reduction in maintenance costs by preventing unexpected battery failures.
                    </div>
                </div>
            </div>
        </div>
