        ...
        <div className={`${styles.mainContent} ${props.customClassName}`}>
            ...
            <div className={`${styles.infoContent}`}>
                <div className={`${styles.contentBox}`}>
                    ...
                    <p>To address these issues, the manufacturer is implementing Shodat eOps™, an advanced asset tracking and quality management platform, to enhance their battery life prediction capabilities.</p>
                </div>
                <div className={`${styles.resultBox}`}>
                    <h3>Results</h3>
                    <div className={`${styles.resultText}`}>The implementation of Shodat eOps™ leading to a significant improvement in the accuracy of battery life predictions, with accuracy rates close to 93%.</div>
