        ...
        <div className={`${styles.mainContent}`}>
            ...
            <div className={`${styles.infoContent}`}>
                ...
                <div className={`${styles.resultBox}`}>
                    ...
                    <div className={`${styles.resultText}`}>Proactive alerting and predictive maintenance strategies resulted in a 25% reduction in maintenance costs by preventing unexpected battery failures.</div>
                </div>
            </div>
        </div>
    )
