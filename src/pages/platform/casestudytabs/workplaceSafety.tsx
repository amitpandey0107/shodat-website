        ...
        <div className={`${styles.mainContent} ${props.customClassName}`}>
            ...
            <div className={`${styles.infoContent}`}>
                <div className={`${styles.contentBox}`}>
                    ...
                    <p>A large manufacturing company faced significant challenges in
                ...
                <div className={`${styles.resultBox}`}>
                    <h3>Results</h3>
                    <div className={`${styles.resultText}`}>Improved incident response time by 30% through real-time
                        ...
                        wearable devices.</div>
                    <div className={`${styles.resultText}`}>Ensured continuous compliance with safety regulations like
