        ...
        <div className={`${styles.mainContent} ${props.customClassName}`}>
            ...
            <div className={`${styles.infoContent}`}>
                ...
                <div className={`${styles.resultBox}`}>
                    <h3>Results</h3>
                    <div className={`${styles.resultText}`}>Achieved a 30% improvement in crack detection accuracy due
                        ...
                        error.</div>
                    <div className={`${styles.resultText}`}>By leveraging Shodat eOps, the client was able to identify
                        and address potential hazards before they escalated,
                        resulting in a 32 % decrease in high severity incidents.</div>
                </div>
            </div>
        </div>
    )
