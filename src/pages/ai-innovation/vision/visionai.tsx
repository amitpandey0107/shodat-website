                                    ...
                                    <div className={`${styles.keyBenefits}`}>
                                        ...
                                        <div className={`${styles.boxContainer}`}>
                                            <div className={`${styles.box}`}>
                                                ...
                                                <p>Detects and classifies a wide range of defects and anomalies.</p>
                                            </div>
                                            <div className={`${styles.box}`}>
                                                <h6>Enhanced Inspection</h6>
                                                <p>Automates routine inspections, reducing manual labor and error rates.</p>
                                            </div>
                                            <div className={`${styles.box}`}>
                        ...
                        <div className="row">
                            ...
                            <div className={`col-sm-12 col-md-12 col-lg-7 ${styles.col2}`}>
                                <div className={`${styles.leftBlock}`}>
                                    ...
                                    <p>Shodat Inc. specializes in developing lightweight machine learning models that deliver high performance without requiring extensive computational resources. These models are ideal for applications where speed and efficiency are critical.</p>
                                    ...
                                    <div className={`${styles.keyBenefits}`}>
                                        ...
                                        <div className={`${styles.boxContainer}`}>
                                            <div className={`${styles.box}`}>
                                                <h6>Scalability</h6>
                                                <p>Easily scalable across various devices and platforms.</p>
                                            </div>
                                            <div className={`${styles.box}`}>
                        ...
                        <div className="row">
                            ...
                            <div className="col-sm-12 col-md-12 col-lg-7">
                                <div className={`${styles.leftBlock}`}>
                                    ...
                                    <p>Our Intelligent Process Automation (IPA) solutions integrate AI and machine learning to automate repetitive tasks, streamline workflows, and enhance operational efficiency. Shodat Inc.&apos;s IPA capabilities help businesses reduce manual labor, minimize errors, and improve productivity.</p>

                                    <div className={`${styles.keyBenefits}`}>
                                        <div className={`${styles.lineLeft}`}></div>
                                        <div className={`${styles.lineRight}`}></div>
                                        <div className={`${styles.lineBottom}`}></div>
                                        <div className={`${styles.benefitTitle}`}>IPA Capabilities</div>
                                        <div className={`${styles.boxContainer}`}>
                                            <div className={`${styles.box}`}>
                                                <h6>Automated Workflows</h6>
                                                <p>Seamless automation of complex business processes.</p>
                                            </div>
                                            <div className={`${styles.box}`}>
                                            ...
                                            <div className={`${styles.box}`}>
                                                ...
                                                <p>Maximizing resource utilization and minimizing waste.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
