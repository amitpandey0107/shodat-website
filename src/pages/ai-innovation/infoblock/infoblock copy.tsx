            ...
            <div className="col-sm-12 col-md-7 col-lg-7">
              <div className={`${styles.leftSection}`}>
                ...
                <div className={`${styles.textRow}`}>
                  <h6>Key Benefits:</h6>
                  <p>
                    <strong>Comprehensive Image Analysis:</strong> Detects and
                    classifies a wide range of defects and anomalies.
                  </p>
                  <p>
                    <strong>Enhanced Inspection:</strong> Automates routine
                    inspections, reducing manual labor and error rates.
                  </p>
                  <p>
                    <strong>Scalable Solutions:</strong> Easily adapts to
