          ...
          <div className="col-sm-12 col-md-6 col-lg-6 col-xl-3">
            <div className={`${styles.purpleBox}`}>
              ...
              <div className={`${styles.contentArea}`}>
                ...
                <p>
                  We help you establish comprehensive data management policies
                  and standards to ensure data quality and compliance.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="col-sm-12 col-md-6 col-lg-6 col-xl-3">
            <div className={`${styles.purpleBox}`}>
              ...
              <div className={`${styles.contentArea}`}>
                ...
                <p>
                  Implement data lineage and auditing mechanisms to track data
                  flow and transformations, ensuring transparency and
                  accountability.
                </p>
              </div>
            </div>
            ...
            <div className={`${styles.purpleBox}`}>
              ...
              <div className={`${styles.contentArea}`}>
                ...
                <p>
                  ...
                  data handling practices are compliant with legal requirements.
                </p>
              </div>
            </div>
          </div>
