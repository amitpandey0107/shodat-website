                ...
                <Slider {...settings}>
                    ...
                    <div className={`${styles.featSlideItemBox}`}>
                        ...
                        <div className={`${styles.itemBottom}`}>
                            ...
                            <p>We transform raw data into intuitive dashboards and reports, making complex data easily understandable. Our team also builds efficient views for report consumption, ensuring that data is presented in a user-friendly manner.</p>
                        </div>
                    </div>
