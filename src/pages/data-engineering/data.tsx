          ...
          <div className="container-fluid">
            <div className="row">
              <div className="col-sm-12">
                ...
                <p>
                  Our expertise in managing large data volumes ensures that your
              ...
              <div className="col-sm-12 col-md-4 col-lg-4">
                <div className={`${styles.dataBox}`}>
                  ...
                  <div className={`${styles.dataRight}`}>
                    ...
                    <p>
                      Implement scalable storage systems like data lakes and
                      cloud storage to handle vast amounts of structured and
                      unstructured data.
                    </p>
                  </div>
                </div>
              ...
              <div className="col-sm-12 col-md-4 col-lg-4">
                <div className={`${styles.dataBox}`}>
                  ...
                  <div className={`${styles.dataRight}`}>
                    ...
                    <p>
                      Leverage distributed computing frameworks such as Apache
                      Spark and Hadoop to process large datasets quickly and
                      efficiently.
                    </p>
                  </div>
                </div>
              ...
              <div className="col-sm-12 col-md-4 col-lg-4">
                <div className={`${styles.dataBox}`}>
                  ...
                  <div className={`${styles.dataRight}`}>
                    ...
                    <p>
                      Enable real-time data processing and analytics to provide
                      immediate insights and support rapid decision-making.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="container-fluid">
            <div className="row">
              <div className="col-sm-12">
                ...
                <p>
                  At Shodat Inc, We prioritize data governance to ensure the
                  accuracy, consistency and security of your data:
                </p>
              </div>
            </div>
          </div>
                ...
                <div className={`${styles.dataBox}`}>
                  ...
                  <div className={`${styles.dataRight}`}>
                    ...
                    <p>
                      ...
                      from unauthorized access, breaches and other cyber
                      threats.
                    </p>
                  </div>
                </div>
              ...
              <div className="col-sm-12 col-md-6 col-lg-6">
                <div className={`${styles.dataBox}`}>
                  ...
                  <div className={`${styles.dataRight}`}>
                    ...
                    <p>
                      We help you establish comprehensive data management
                      policies and standards to ensure data quality and
                      compliance.
                    </p>
                  </div>
                </div>
              ...
              <div className="col-sm-12 col-md-6 col-lg-6">
                <div className={`${styles.dataBox}`}>
                  ...
                  <div className={`${styles.dataRight}`}>
                    ...
                    <p>
                      Implement data lineage and auditing mechanisms to track
                      data flow and transformations, ensuring transparency and
                      accountability.
                    </p>
                  </div>
                </div>
              ...
              <div className="col-sm-12 col-md-6 col-lg-6">
                <div className={`${styles.dataBox}`}>
                  ...
                  <div className={`${styles.dataRight}`}>
                    ...
                    <p>
                      Our solutions adhere to industry regulations such as GDPR,
                      HIPAA and CCPA, providing you with peace of mind that your
                      data handling practices are compliant with legal
                      requirements.
                    </p>
                  </div>
                </div>
