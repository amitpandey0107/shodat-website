  ...
  return (
    <div className={`${styles.ourCapabilities}`}>
      <div className={`${styles.capabilitiesBox}`}>
        ...
        <h4>
          Our team excels in constructing robust data pipelines that manage data
          workflows and processing efficiently.{" "}
        </h4>
        <p>
          These pipelines are essential for ensuring that data is moved
