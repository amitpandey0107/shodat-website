...
export default function FeatureSlider(props: any) {
  ...
  return (
    <div
      className={`slider-container featureSlickSlider ${
        ...
        <Slider {...settings}>
          ...
          <div className={`${styles.featSlideItemBox}`}>
            ...
            <div className={`${styles.itemBottom}`}>
              ...
              <p>
                We support both near real-time data ingestion and bulk uploads,
          ...
          <div className={`${styles.featSlideItemBox}`}>
            ...
            <div className={`${styles.itemBottom}`}>
              ...
              <p>
                Automate your data ingestion processes with our scheduled upload
                capabilities, reducing manual intervention and ensuring
                consistency.
              </p>
            </div>
          </div>
