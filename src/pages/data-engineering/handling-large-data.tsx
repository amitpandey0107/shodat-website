          ...
          <div className="col-sm-12 col-md-4 col-lg-3">
            <div className={`${styles.whiteBox}`}>
              ...
              <div className={`${styles.contentArea}`}>
                ...
                <p>
                  Implement scalable storage systems like data lakes and cloud
                  storage to handle vast amounts of structured and unstructured
                  data.
                </p>
              </div>
            </div>
          ...
          <div className="col-sm-12 col-md-4 col-lg-3">
            <div className={`${styles.whiteBox}`}>
              ...
              <div className={`${styles.contentArea}`}>
                ...
                <p>
                  Leverage distributed computing frameworks such as Apache Spark
                  and Hadoop to process large datasets quickly and efficiently.
                </p>
              </div>
            </div>
          </div>
