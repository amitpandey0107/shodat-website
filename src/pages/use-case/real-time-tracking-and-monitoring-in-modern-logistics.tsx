...
export default function RealtimeTrackingMonitoring(props: any) {
    const data = {
        ...
        "info_1": "A global logistics firm utilized a combination of IoT sensors, GPS tracking, and advanced analytics platforms to achieve real-time visibility into their operations. With this setup Shodat Inc, enabled them to track shipments, monitor vehicle status, and get immediate insights into any delays or issues.",
        "info_2":"",
        "info_4":"",
        "boxedInfo": [
            {
