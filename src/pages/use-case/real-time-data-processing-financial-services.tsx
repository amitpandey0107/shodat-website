...
export default function RealTimeDataProcessingFinancialServices(props: any) {
    const data = {
        ...
        "info_1": "A leading retail and e-commerce company sought to enhance its data management capabilities to improve decision-making, optimize operations, and boost profitability. The company faced several challenges, including fragmented data sources, inefficient data processing, and inadequate insights into customer behavior and sales trends.",
        "info_2":"With Shodat Inc, the company  uses advanced ETL (Extract, Transform, Load) processes to handle massive amounts of data The company extracted data from multiple sources including point-of-sale systems, customer relationship management (CRM) software, social media platforms, and product review sites.",
        "info_3":"The ETL processes managed over 1TB of data daily, ensuring that all relevant information was captured and ready for transformation.The extracted data underwent cleansing, normalization, and enrichment to ensure consistency and accuracy, maintaing data availability at 99.9%.",
        "boxedInfo": [
            {
                "highlight":"1TB",
