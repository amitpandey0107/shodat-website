...
export default function PredictiveAnalytics(props: any) {
    const data = {
        ...
        "info_4":"The system provided insights into the health of the machinery, allowing the maintenance team to perform necessary repairs before any breakdowns occurred.",
        "boxedInfo": [
            {
                "highlight":"30%",
                "text":"By predicting equipment failures"
            },
            {
                "highlight":"20%",
                "text":"The company saved approximately maintenance costs"
            },
            {
                "highlight":"15%",
                "text":"Overall production efficiency increased"
            }
        ],
        "points": [
            {
