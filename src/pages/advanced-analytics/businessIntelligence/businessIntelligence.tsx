                    ...
                    <div className="row">
                        <div className="col-sm-12">
                            <div className={`${styles.titleCenter}`}>
                                <h1 className={`${styles.titleUnderline}`}>Shodat Inc Your Partner in Business <br />Intelligence Implementation</h1>
                                <p>At Shodat Inc, we specialize in delivering robust Business Intelligence (BI) solutions tailored to meet the unique needs of your business. With years of experience and a dedicated team of BI experts, we offer comprehensive services that empower organizations to harness the full potential of their data.</p>
                            </div>
                        </div>
                    </div>
                </div>
