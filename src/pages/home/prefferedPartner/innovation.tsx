...
export default function Innovation() {
  return (
    <div
      className={`${styles.tabsContent} ${styles.innovation} ${styles.innovationBG} innovationSection`}
    >
        ...
        <div className={`${styles.contentLeft}`}>
          <div className={`${styles.contentBlock}`}>
            ...
            <p>
              ...
              of innovation, unlocking endless opportunities for growth and
              value generation for the industry
            </p>
          </div>
        </div>
        <div className={`${styles.contentRight}`}>
          <div className={`${styles.contentBlock}`}>
            ...
            <p>
              ...
              your business, adapting to new challenges and opportunities in the
